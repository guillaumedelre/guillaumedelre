...
- [Symfony 8.1: HTTP-less kernel, declarative rate limiting, and Messenger batch fetching](https://guillaumedelre.github.io/2026/06/04/symfony-8.1-http-less-kernel-declarative-rate-limiting-and-messenger-batch-fetching/) (1 day ago)
...
- [The Cache That Was Lying to Us](https://guillaumedelre.github.io/2026/05/16/the-cache-that-was-lying-to-us/) (2 weeks ago)
- [Fifteen Minutes Before the First Test](https://guillaumedelre.github.io/2026/05/16/fifteen-minutes-before-the-first-test/) (2 weeks ago)

#### 👷 Check out what I'm currently working on

- [guillaumedelre/miru](https://github.com/guillaumedelre/miru) - Application de suivi d&#39;animes, séries et films avec calendrier de diffusion hebdomadaire (today)
- [guillaumedelre/guillaumedelre.github.io](https://github.com/guillaumedelre/guillaumedelre.github.io) - Tech experiments told as stories · PHP, Symfony, IoT, devops · Jekyll on GitHub Pages (1 day ago)
- [dg/bypass-finals](https://github.com/dg/bypass-finals) - Removes `final` and `readonly` keywords from source code on-the-fly and allows mocking of final methods and classes. It can be used together with any test tool such as PHPUnit or Mockery. (4 days ago)
- [guillaumedelre/reqlet](https://github.com/guillaumedelre/reqlet) - Open source API client: native desktop GUI, CI-ready CLI, and self-hostable web agent. Postman-compatible, offline-first, no account required. (5 days ago)
...
- [guillaumedelre/miru](https://github.com/guillaumedelre/miru) - Application de suivi d&#39;animes, séries et films avec calendrier de diffusion hebdomadaire
...
- [dg/bypass-finals](https://github.com/dg/bypass-finals) ([v1.10.1](https://github.com/dg/bypass-finals/releases/tag/v1.10.1), 4 days ago) - Removes `final` and `readonly` keywords from source code on-the-fly and allows mocking of final methods and classes. It can be used together with any test tool such as PHPUnit or Mockery.
