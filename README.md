...
- [I stopped waiting for TVTime](https://guillaumedelre.github.io/2026/06/06/i-stopped-waiting-for-tvtime/) (1 month ago)
...
- [guillaumedelre/3d-assets-viewer](https://github.com/guillaumedelre/3d-assets-viewer) -  (6 days ago)
...
- [snc/SncRedisBundle](https://github.com/snc/SncRedisBundle) ([4.13.0](https://github.com/snc/SncRedisBundle/releases/tag/4.13.0), today) - A Redis bundle for Symfony supporting Predis and PhpRedis
- [symfony/symfony](https://github.com/symfony/symfony) ([v8.1.2](https://github.com/symfony/symfony/releases/tag/v8.1.2), today) - The Symfony PHP framework
- [dg/bypass-finals](https://github.com/dg/bypass-finals) ([v1.11.0](https://github.com/dg/bypass-finals/releases/tag/v1.11.0), 5 days ago) - Removes `final` and `readonly` keywords from source code on-the-fly and allows mocking of final methods and classes. It can be used together with any test tool such as PHPUnit or Mockery.
- [guillaumedelre/3d-assets-viewer](https://github.com/guillaumedelre/3d-assets-viewer) ([v1.1.0](https://github.com/guillaumedelre/3d-assets-viewer/releases/tag/v1.1.0), 6 days ago) - 
